                    ...
                    for valid_name, val_mos_root, val_loader in zip(valid_names, valid_MOSs, valid_loaders):
                        ...
                        with open(txt_Fname, 'a') as f:
                            for val_data in val_loader:
                                ...
                                # /home/liuhongzhi/Method/IQA/SEU-IQA/codes/models/modules/Our_IQA.py class Our_IQA(nn.Module)
                        ...
                        PLCC =  MOS_list_pd.corr(IQA_list_pd, method='pearson')     
                        ...
                        print(f"Validation # {valid_name}: PLCC: {PLCC:.4f} SROCC: {SROCC:.4f}")
                        logger.info('# Validation # {} PLCC: {:.4f} SROCC: {:.4f}'.format(valid_name, PLCC, SROCC))
                        tb_logger.add_scalar('{}_PLCC'.format(valid_name), PLCC, current_step)
