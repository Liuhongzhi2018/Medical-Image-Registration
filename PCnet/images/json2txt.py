...
if __name__ == "__main__":
    ...
    json_file = "/mnt/lhz/Github/Image_registration/voxelmorph/images/ACDC/test.json"
    txt_file = "/mnt/lhz/Github/Image_registration/voxelmorph/images/ACDC/test_img_seg_list.txt"
    json2txt1(json_file, txt_file)