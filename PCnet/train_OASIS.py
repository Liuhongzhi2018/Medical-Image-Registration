...
def main():
    batch_size = 1
    train_file = '/mnt/lhz/Github/Image_registration/PCnet/images/OASIS/train_img_seg_list.txt'
    val_file = '/mnt/lhz/Github/Image_registration/PCnet/images/OASIS/test_img_seg_list.txt'
    checkpoint_dir = '/mnt/lhz/Github/Image_registration/PCnet/PCnet_checkpoints/OASIS/'
