...
class ACDCDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # ACDCDataset x shape: (160, 224, 192) y shape: (160, 224, 192)
...
class ACDCDatasetVal(Dataset):
    ...
    def __getitem__(self, index):
        ...
        y = self.read_vol(y)
        y_seg = self.read_vol(y_seg)
        # print(f"ACDCDataset x shape: {x.shape} y shape: {y.shape} x_seg shape: {x_seg.shape} y_seg shape: {y_seg.shape}")
