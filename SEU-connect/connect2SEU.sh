...
# set cookie, sunriseUsername=220222134
...
reply_json=`curl -d "username=220222134&password=307235&enablemacauth=0" http://w.seu.edu.cn/index.php/index/login  --cookie $COOKIE 2> /dev/null`
