...
def train(data_folder=".", model_folder="runs"):
    ...
    train_ds = CacheDataset(data=train_files, transform=train_transforms, cache_rate=.5, num_workers=4)
    val_ds = CacheDataset(data=val_files, transform=val_transforms, cache_rate=.5, num_workers=4)
