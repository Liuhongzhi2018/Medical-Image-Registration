...
# CUDA_VISIBLE_DEVICES=1 python ankle_fracture_class_282_95_98_103_mask_level1.py train --model_folder "/mnt/lhz/Github/SEU_Ankle_MONAI/class_checkpoints"
...
def train(checkpoint_dir = "."):
    image_label_txt = "../data/trainvaltest_level1_2829598103_mask.txt"
    images, labels_list = [], []
...
if __name__ == "__main__":
    ...
    cdir = os.path.join(args.model_folder, "Densenet169_2829598103_level1_mask"+"_"+current_time)
