...
# CUDA_VISIBLE_DEVICES=0 python ankle_fracture_class_285_45_282_image.py train --model_folder "class_checkpoints"
# CUDA_VISIBLE_DEVICES=1 python ankle_fracture_class_282_95_98_103_image_level1.py train --model_folder "/mnt/lhz/Github/SEU_Ankle_MONAI/class_checkpoints"

# train/val
# images num: 578 labels num: 578
# All label with number: {1: 164, 2: 230, 3: 175, 0: 9}
# All train label with number: {1: 97, 2: 137, 3: 83, 0: 5}
# All val label with number: {1: 33, 2: 46, 3: 44, 0: 2}

# train/test
# images num: 578 labels num: 578
# All label with number: {1: 164, 2: 230, 3: 175, 0: 9}
# All train label with number: {1: 97, 2: 137, 3: 83, 0: 5}
# All val label with number: {1: 34, 2: 47, 3: 48, 0: 2}
...
def show_confusion_matrix(epoch, n_classes, y_test, y_score, checkpoint_dir):
    ...
    cm = confusion_matrix(y_test, y_score, labels=[0, 1, 2, 3])
...
def train(checkpoint_dir = "."):
    image_label_txt = "../data/trainvaltest_level1_2829598103_image.txt"
    images, labels_list = [], []
    ...
    train_ds = CacheDataset(data=train_files, transform=train_transforms, cache_rate=0.5, num_workers=8)
    ...
    val_ds = CacheDataset(data=val_files, transform=val_transforms, cache_rate=0.5, num_workers=8)
    val_loader = DataLoader(val_ds, batch_size=1, num_workers=8, pin_memory=torch.cuda.is_available())
...
if __name__ == "__main__":
    ...
    cdir = os.path.join(args.model_folder, "Densenet169_2829598103_level1_image"+"_"+current_time)
