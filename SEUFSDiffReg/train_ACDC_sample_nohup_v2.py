...
def compute_per_class_Dice_HD95_IOU(pre, gt, gtspacing):
    ...
    mean_iou = statistics.mean(n_iou_list)
    return mean_Dice, mean_HD95, mean_iou, n_dice_list, n_hd95_list, n_iou_list
    # return n_dice_list, n_hd95_list, n_iou_list
...
if __name__ == "__main__":
    ...
    while current_epoch < n_epoch:
        ...
        if current_epoch % opt['train']['val_freq'] == 0:
            # dice_dict, hd95_dict, iou_dict, tre_list = {}, {}, {}, []
            # dice_dict['RV'] = dice_dict['Myo'] = dice_dict['LV'] = []
            # hd95_dict['RV'] = hd95_dict['Myo'] = hd95_dict['LV'] = []
            # iou_dict['RV'] = iou_dict['Myo'] = iou_dict['LV'] = []
            ...
            for istep, test_data in enumerate(test_loader):
                ...
                tre_list.append(tre)
                # print(f"dice_RV_list: {dice_RV_list} \ndice_Myo_list: {dice_Myo_list} \ndice_LV_list: {dice_LV_list}")
                # print(f"hd95_RV_list: {hd95_RV_list} \nhd95_Myo_list: {hd95_Myo_list} \nhd95_LV_list: {hd95_LV_list}")
                # print(f"iou_RV_list: {iou_RV_list} \niou_Myo_list: {iou_Myo_list} \niou_LV_list: {iou_LV_list}")
                
                # dRV, dMyo, dLV = d_list[0], d_list[1], d_list[2]
                # hdRV, hdMyo, hdLV = hd95_list[0], hd95_list[1], hd95_list[2]
                # iRV, iMyo, iLV = IOU_list[0], IOU_list[1], IOU_list[2]
                # print(f" dRV {dRV} dMyo {dMyo} dLV {dLV}")
                # print(f" hdRV {hdRV} hdMyo {hdMyo} hdLV {hdLV}")
                # print(f" iRV {iRV} iMyo {iMyo} iLV {iLV}")
                # dice_dict['RV'].append(dRV)
                # dice_dict['Myo'].append(dMyo)
                # dice_dict['LV'].append(dLV)
                # hd95_dict['RV'].append(hdRV)
                # hd95_dict['Myo'].append(hdMyo)
                # hd95_dict['LV'].append(hdLV)
                # iou_dict['RV'].append(iRV)
                # iou_dict['Myo'].append(iMyo)
                # iou_dict['LV'].append(iLV)
                # tre_list.append(tre)
...
# d_list: [0.7907788633219753, 0.727586471663766, 0.924960935243609] hd95_list: [3.0571297857495683, 2.734380006790161, 3.0571297857495683] IOU_list: [0.6539572010869565, 0.5718160522746887, 0.8603975174797706]
# dice_dict: {'RV': [0.7907788633219753, 0.727586471663766, 0.924960935243609], 'Myo': [0.7907788633219753, 0.727586471663766, 0.924960935243609], 'LV': [0.7907788633219753, 0.727586471663766, 0.924960935243609]} hd95_dict: {'RV': [3.0571297857495683, 2.734380006790161, 3.0571297857495683], 'Myo': [3.0571297857495683, 2.734380006790161, 3.0571297857495683], 'LV': [3.0571297857495683, 2.734380006790161, 3.0571297857495683]} iou_dict: {'RV': [0.6539572010869565, 0.5718160522746887, 0.8603975174797706], 'Myo': [0.6539572010869565, 0.5718160522746887, 0.8603975174797706], 'LV': [0.6539572010869565, 0.5718160522746887, 0.8603975174797706]}
# ------ Saving training samples 1 patient132 ------
# d_list: [0.5057014602685098, 0.575469760331604, 0.8179088427994163] hd95_list: [12.233130468851932, 4.798228536384804, 6.116565234425966] IOU_list: [0.338420638046475, 0.40397160399079046, 0.6919169010251293]
# dice_dict: {'RV': [0.7907788633219753, 0.727586471663766, 0.924960935243609, 0.5057014602685098, 0.575469760331604, 0.8179088427994163], 'Myo': [0.7907788633219753, 0.727586471663766, 0.924960935243609, 0.5057014602685098, 0.575469760331604, 0.8179088427994163], 'LV': [0.7907788633219753, 0.727586471663766, 0.924960935243609, 0.5057014602685098, 0.575469760331604, 0.8179088427994163]} hd95_dict: {'RV': [3.0571297857495683, 2.734380006790161, 3.0571297857495683, 12.233130468851932, 4.798228536384804, 6.116565234425966], 'Myo': [3.0571297857495683, 2.734380006790161, 3.0571297857495683, 12.233130468851932, 4.798228536384804, 6.116565234425966], 'LV': [3.0571297857495683, 2.734380006790161, 3.0571297857495683, 12.233130468851932, 4.798228536384804, 6.116565234425966]} iou_dict: {'RV': [0.6539572010869565, 0.5718160522746887, 0.8603975174797706, 0.338420638046475, 0.40397160399079046, 0.6919169010251293], 'Myo': [0.6539572010869565, 0.5718160522746887, 0.8603975174797706, 0.338420638046475, 0.40397160399079046, 0.6919169010251293], 'LV': [0.6539572010869565, 0.5718160522746887, 0.8603975174797706, 0.338420638046475, 0.40397160399079046, 0.6919169010251293]}
# ------ Saving training samples 2 patient122 ------
