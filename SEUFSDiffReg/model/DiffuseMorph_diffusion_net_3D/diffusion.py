...
class GaussianDiffusion(nn.Module):
    ...
    def p_sample_loop(self, x_in, nsample, continous=False):
        ...
        # print(f"deform {deform.shape} flow {flow.shape} defm_stack {defm_stack.shape} flow_stack {flow_stack.shape}")
        # deform torch.Size([1, 1, 32, 128, 128]) flow torch.Size([1, 3, 32, 128, 128]) defm_stack torch.Size([33, 1, 32, 128, 128]) flow_stack torch.Size([33, 3, 32, 128, 128])
        if continous:
