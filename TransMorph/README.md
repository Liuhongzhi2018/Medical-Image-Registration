...
CUDA_VISIBLE_DEVICES=1 python train_TransMorph_OASIS.py

CUDA_VISIBLE_DEVICES=0 python train_TransMorph_ACDC.py

CUDA_VISIBLE_DEVICES=2 python train_TransMorph_LPBA.py

CUDA_VISIBLE_DEVICES=1 python train_TransMorph_OAIZIB.py
